...
<head>
    ...
    <title>GP SERVICE - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">GP SERVICE<sup></sup></div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ asset('gpservice') }}/assets/favicon.png">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('pelanggan', []) }}">Tampil Data</a>
                        <a class="collapse-item" href="{{ url('pelanggan/create', []) }}">Tambah Data</a>
                        <h6 class="collapse-header">Worker:</h6>
                        <a class="collapse-item" href="{{ url('penjoki', []) }}">Tampil Data</a>
                        <a class="collapse-item" href="{{ url('penjoki/create', []) }}">Tambah Data</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="\gpservis\public\guest.png">
                            </a>
